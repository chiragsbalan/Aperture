...
- **Username live check:** [ADR-0018](decisions/ADR-0018-username-availability-check.md) — BFF-secret-gated exact check + optional DIY bloom in one slice (signup + rename); soft-delete reclaim deferred.
...
- **Interim search recall:** [ADR-0016](decisions/ADR-0016-interim-search-recall.md) — pre-P6 hybrid façade (warm FTS + TMDb External/Related sections); OpenSearch still P6.
