"""Normalize polymorphic content refs for lists and diary (ADR-0004).
...
class UnsupportedContentTypeError(ValueError):
    """Raised when a content type cannot be stored on a list or diary entry."""
...
def to_public_content_type(db_type: str) -> PublicContentType:
    """Map a persisted content type to the public API type."""
